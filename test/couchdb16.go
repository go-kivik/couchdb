...
func registerSuiteCouch16() {
	kiviktest.RegisterSuite(kiviktest.SuiteCouch16, kt.SuiteConfig{
		...
		"Find.status":        http.StatusNotImplemented, // Couchdb 1.6 doesn't support the find interface
		"CreateIndex.status": http.StatusNotImplemented, // Couchdb 1.6 doesn't support the find interface
		...
		"Explain.status":     http.StatusNotImplemented, // Couchdb 1.6 doesn't support the find interface
