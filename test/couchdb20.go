...
func registerSuiteCouch20() {
	kiviktest.RegisterSuite(kiviktest.SuiteCouch20, kt.SuiteConfig{
		...
		"PutAttachment/RW/group/NoAuth/Conflict.status":        http.StatusInternalServerError, // COUCHDB-3361
		...
		"DeleteAttachment/RW/group/NoAuth/NoDoc.status":     http.StatusInternalServerError,
